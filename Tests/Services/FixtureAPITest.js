...
import FixtureAPI from '../../App/Services/ApiService/FixtureApi'
import R from 'ramda'
...
test('FixtureAPI getRate returns the right file', () => {
  const expectedFile = require('../../Resources/Fixtures/rateLimit.json')
...
test('FixtureAPI getUser returns the right file for gantman', () => {
  const expectedFile = require('../../Resources/Fixtures/gantman.json')
...
test('FixtureAPI getUser returns the right file for skellock as default', () => {
  const expectedFile = require('../../Resources/Fixtures/skellock.json')
